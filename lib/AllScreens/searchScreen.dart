import 'package:cary_driver/AllWidgets/Divider.dart';
...
import 'package:cary_driver/Models/placePredictions.dart';
...
class _SearchScreenState extends State<SearchScreen> {
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Ubicaciones del viaje", style: TextStyle(fontSize: 18.0, fontFamily: "Brand-Bold"),),
                      )
                    ],
                  ),
          ...
          (placePredictionsList.length > 0) ?
              Padding(
                ...
                child: ListView.separated(
                  ...
                  {
                    return PredictionTitle(placePredictions: placePredictionsList[index],);
                  },
  ...
  void findPlace(String placeName) async
  {
    if(placeName.length > 1){
      ...
      print("Petición de predicción de lugar :: ");
      print(res);
    }
  }
    ...
    if(res["status"] == "OK")
      {
        ...
        print("Esta es la ubicación de recogida :: ");
